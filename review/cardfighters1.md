...
### `070080`  46 → 49바이트  (빈 곳으로 옮겨 담음)

```
원문 | ERROR OCCURRED
원문 | WHILE SAVING DATA.
원문 | TRY AGAIN?
원문 | {0C}
```
...
```
원문 |  ARRANGE DECK   DECK IN USE
원문 |  CARD ALBUM    DECK NAME
```
...
```
원문 | AUTO-DECK CAN'T BE FORMED
원문 | WITHOUT 50 OR MORE CHA CARDS.
```

```
번역 | 캐릭터 카드가 50장 넘게 없으면
번역 | 자동으로 덱을 못 짭니다.
```
...
```
원문 |  PUSH OPTION TO GO TO COLUMN
```
...
```
원문 | WHEN THIS DECK IS TOSSED
원문 | ALL CARDS WILL BE LOST.
원문 | OK TO TOSS DECK?
원문 | {0D}
```
...
### `0700E8`  31 → 37바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU GOT A
원문 | "LOST WORLD" SC COIN.
```
...
### `0700EC`  32 → 39바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU GOT A
원문 | "NEOGEO LAND" SC COIN.
```
...
### `0700F0`  33 → 37바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU GOT A
원문 | "PLAZA CAPCOM" SC COIN.
```
...
### `0700F4`  34 → 38바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU GOT A
원문 | "RESIDENT EVIL" SC COIN.
```
...
### `0700F8`  30 → 38바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU GOT A
원문 | "LAS VEGAS" SC COIN.
```
...
```
원문 | CHOOSE A CARD TO LOOK AT
원문 | (PUSH B BUTTON TO END)
```
...
```
원문 | ENTER YOUR COM NO.
원문 | SAVE COM UNIT
원문 | SEARCH FOR COM UNIT
```
...
### `072268`  40 → 42바이트  (빈 곳으로 옮겨 담음)

```
원문 | SAVE "COM NO." FOR
원문 | COM UNIT (LINK PAL'S)
```
...
```
원문 | SEARCH FOR NEARBY
원문 | COM UNIT TO LINK WITH
```
...
### `072270`  31 → 35바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU MUST SET YOUR
원문 | OWN "COM NO."
```
...
### `07228C`  18 → 20바이트  (빈 곳으로 옮겨 담음)

```
원문 |  COM UNIT PAL LIST
```
...
원문 | RING     TURN
원문 | FREEZE    PHASE
원문 | BACK-UP 1  PHASE 1
원문 | BACK-UP 2  PHASE 2
원문 | ]ABILITY  PHASE 3
원문 | [ABILITY  PHASE 4
원문 | \ABILITY  TO BACK
```
...
```
원문 | (ANOTHER ZOMBIE IS AFTER YOU!!)
```
...
원문 | {08} ESCAPED!
원문 | 
원문 | BUT YOUR SURROUNDED!
원문 | 
원문 | (IT'S NO GOOD! YOUR TRAPPED!)
원문 | 
원문 | WHAT WILL YOU DO?!
원문 | 
원문 | RUN AWAY?
...
```
원문 | NOTE
원문 | "JUST FOUND THIS OUT YESTERDAY.
원문 | THERE'S AN 'SNK VERSION'
원문 | AND A 'CAPCOM VERSION' OF
원문 | CARD CLASH, YOU KNOW.
원문 | THE GAME OPENING'S ARE A LITTLE
원문 | DIFFERENT.
원문 | DID'JA KNOW THAT?"
```
...
```
원문 | (YES, TARGET FRONT CARD.)
원문 | 
원문 | (THE ARM MOVES...)
원문 | 
원문 | MOVE ARM A LITTLE MORE?
원문 | {0D}
```
...
### `0714AC`  24 → 26바이트  (빈 곳으로 옮겨 담음)

```
원문 | TAKE ARM TO BACK ROOM?
원문 | {0D}
```
...
```
원문 | (IT'S THE JOY JOY KID!)
원문 | 
원문 | (...THIS IS THE KID'S FAVORITE,
원문 | THE PUZZLE GAME...)
```
...
원문 | (IT'S THE JOY JOY KID!)
원문 | 
원문 | (...THIS IS THE OWNER'S FAVORITE,
원문 | THE PUZZLE GAME...)
```
...
원문 | (IT'S THE JOY JOY KID!)
원문 | 
원문 | ({7F}A WELL-KNOWN PUZZLE GAME {7F})
```

```
번역 | (조이조이 키드다!)
번역 | 
번역 | ({7F}잘 알려진 퍼즐 게임이다{7F})
```

### `0714D0`  53 → 46바이트

```
원문 | (SP MAX INCREASES 2 PTS.)
원문 | 
원문 | (THAT'S A DIFFERENT GAME.)
```
...
원문 | BULLETIN BOARD
원문 | "BASIC RULE 1
원문 | WHEN CHA CARD IS RETURNED TO
원문 | A HAND
원문 | BP AND ABILITIES RETURN TO
원문 | NORMAL
원문 | FOR CHARACTERS WITH DECREASED
원문 | BP,
원문 | IF YOU CAN RETURN THEM TO
원문 | YOUR HAND,
원문 | BP'S RESTORED. WHEN YOU PUT
원문 | THEM BACK
원문 | IN THE RING,
원문 | BP BECOMES HIGHEST.
```
...
원문 | BULLETIN BOARD
원문 | "BASIC RULE 2
원문 | IN UNITE ATTACKS, EFFECTS OF
원문 | \ABILITIES ARE NULLIFIED.
원문 | FOR EXAMPLE...
원문 | 
원문 | IN UNITE ATTACKS, HEIDERN'S
원문 | 'S BRINGER'
원문 | CAN'T BE USED TO STEAL AN
원문 | ENEMY'S SP."
```
...
원문 | BULLETIN BOARD
원문 | "BASIC RULE 3
원문 | A CHARACTER HAS ONLY ONE
원문 | ABILITY.
원문 | WHEN ANOTHER ABILITY IS
원문 | GAINED...
원문 | THE PREVIOUS ABILITY IS
원문 | REPLACED BY THE NEWER ONE."
```
...
원문 | BULLETIN BOARD
원문 | "BASIC RULE 4
원문 | WHEN BP RISES WITH BACK-UP...
원문 | 
원문 | BP BECOMES 300 REGARDLESS OF
원문 | THE BACK-UP CHARACTER'S BP."
```
...
```
원문 | SIGN
원문 | "SC CARD CLASH IN PROGRESS!
원문 | IT'S NOT HARD TO LEARN!
원문 | ANYONE WITH A DECK CAN ENTER!
원문 | THAT MEANS YOU!
원문 | HOW ABOUT JOINING NOW?!"
```
...
### `071624`  65 → 67바이트  (빈 곳으로 옮겨 담음)

```
원문 | SIGN
원문 | "THE TOURNAMENT BEGINS!
원문 | KEEP ON FIGHTING
원문 | AND WIN NEW CARDS!"
```
...
### `071628`  72 → 74바이트  (빈 곳으로 옮겨 담음)

```
원문 | SIGN
원문 | "YOU GOT ENOUGH CARDS?
원문 | NOW USE THEM TO MAKE
원문 | YOUR OWN SPECIAL DECK!"
```
...
```
원문 | SIGN
원문 | "HAVE YOU USED THE TRADING
원문 | MACHINE?
원문 | TRADE 1 CARD CHOSEN RANDOMLY
원문 | WITH 5 TO 10 OF YOUR CARDS.
원문 | YOU MAY GET A CARD THAT 
원문 | YOU CAN'T NORMALLY GET!"
```
...
```
원문 | SIGN
원문 | "TRADE AT THE 'CARD TRADE SHOP'!
원문 | IF YOU HAVE 3 CARDS WHOSE
원문 | RARITY
원문 | IS ABOVE THE ONE YOU WANT,
원문 | YOU CAN GET THE NEW CARD.
원문 | SO BRING YOUR COLLECTION IN!"
```
...
```
원문 | SIGN
원문 | "SC CARD CLASH TOURNAMENT
원문 | NOTICE!
원문 | THE TOURNAMENT'S IN
원문 | LAS VEGAS AT THE SC HOTEL!
원문 | THE SC HOTEL IS SNK AND CAPCOM'S
원문 | GIGANTIC AMUSEMENT HOTEL!"
```
...
```
원문 | SIGN
원문 | "SC HOTEL EVENT NOTICE!
원문 | CARD CLASH TOURNAMENT
원문 | AT THE SC HOTEL IN LAS VEGAS!
원문 | THE WINNER WILL RECEIVE
원문 | A FABULOUS RARE CARD!"
```
...
```
원문 | BULLETIN BOARD
원문 | "MOVE WHILE PUSHING THE B
원문 | BUTTON
원문 | NOW YOU KNOW HOW TO DASH!"
```
...
```
원문 | BULLETIN BOARD
원문 | "HERE'S A HELPFUL COMMAND!
원문 | PUSH THE OPTION BUTTON
원문 | ON THE DECK REARRANGE SCREEN
원문 | TO LOOK AT CARD DATA!"
```
...
원문 | BULLETIN BOARD
원문 | "MASK INFO!
원문 | THE ELUSIVE CARD CRUSADER
원문 | SEEN YESTERDAY IN LOST WORLD!"
```

```
번역 | 게시판
번역 | "마스크 정보!
번역 | 그 종잡을 수 없는 카드 투사가
번역 | 어제 로스트 월드에 나타났다!"
```
...
원문 | "HERE'S A HELPFUL COMMAND!
원문 | PUSH THE OPTION BUTTON
원문 | ON THE BASIC BATTLE SCREEN...
원문 | AND THE CURSOR MOVES TO 'END.'
원문 | 
원문 | PUSH THE OPTION BUTTON AGAIN
원문 | TO END THE BATTLE."
```
...
원문 | BULLETIN BOARD
원문 | "HERE'S A HELPFUL COMMAND!
원문 | CHOOSE 'AUTO' WHILE MAKING
원문 | A NEW DECK, AND CARDS WILL BE
원문 | CHOSEN IN THE HIGHEST BP ORDER
원문 | TO MAKE A MIGHTY DECK!"
```
...
원문 | BULLETIN BOARD
원문 | "HERE'S A HELPFUL COMMAND!
원문 | USE THE B BUTTON AND JOYSTICK
원문 | IN COMBINATION TO SEE
원문 | VARIOUS TYPES OF INFO
원문 | ON THE SCREEN AT A GLANCE!
원문 | AND PUSH THE OPTION BUTTON
원문 | ON THE 'HAND SELECT' SCREEN
원문 | TO REARRANGE CARDS IN YOUR
원문 | HAND."
```
...
```
원문 | (SASUKE VS COMMANDER!)
원문 | 
원문 | (...SORRY, CAN'T PLAY DURING
원문 | ADJUSTMENT PHASE.)
```
...
```
원문 | (IT'S NEO-CARNIVAL!{7F}
원문 | CARDS ARE IN CAPSULES.)
원문 | PLAY NEO-CARNIVAL?
원문 | {0C}
```
...
```
원문 | (THE CRANE'S GOT THE CAPSULE...)
원문 | 
원문 | (JUST A LITTLE MORE AND...
원문 | YOU DROPPED IT!)
```
...
원문 | (THE CRANE'S GOT THE CAPSULE...)
원문 | 
원문 | (EXCELLENT! YOU GOT IT!
원문 | AND INSIDE YOU FIND...)
```
...
```
원문 | NOTE
원문 | "HEARD ABOUT THE RUMOR FOR
원문 | A NEW 'FATAL FURY' GAME TEST.
원문 | IS IT REAL, OR BALONEY?"
```
...
```
원문 | NOTE
원문 | "THIS DRAWING DEDICATD TO
원문 | YAMA-CHAN.
원문 | LEE REKKA LIVES!
원문 | LONG LIVE PIG-TAILS!!!"
```
...
```
원문 | NOTE
원문 | "TELL ME HOW TO MAKE THE
원문 | RIGHT 'UNITE ATTACK' COMBO."
```
...
```
원문 | NOTE
원문 | "I PLAYED 'STREET FIGHTER 3'
원문 | TODAY.
원문 | BLOCKING'S NOT AS EASY AS IT
원문 | SEEMS!
원문 | WORK ON YOUR BLOCKING,
원문 | EVERYBODY!!"
```
...
```
원문 | NOTE
원문 | "I SAW A GIRL JUST LIKE SAKURA.
원문 | SHE SAID, 'KONNA TOKO DA NE!'
원문 | KNOW WHAT IT MEANS?"
```
...
```
원문 | NOTE
원문 | "YOU PROBABLY KNOW THIS...
원문 | FROZEN CHA CARDS CAN'T 
원문 | GET BACK-UP. BUMMER, HUH?"
```
...
```
원문 | NOTE
원문 | "THIS IS A SECRET, BUT...
원문 | WHEN YOU TRADE CARDS
원문 | WITH FRIENDS, SOME CHANGE."
```
...
원문 | NOTE
원문 | "BIG SCOOP!!
원문 | THERE ARE CARDS FOUND
원문 | ONLY IN TRADING MACHINES!
원문 | USE A NUMBER OF CARDS IN
원문 | VARIOUS COMBINATIONS TO GET
원문 | RARE CARDS!"
```
...
```
원문 | NOTE
원문 | "HAVE YOU SEEN MASK?
원문 | BEAT HIM A NUMBER OF TIMES
원문 | AND HE'LL GIVE YOU A COOL CARD.
원문 | YOU MIGHT GET ONE NEXT!"
```
...
```
원문 | (A BIG-SCREEN MONITOR.
원문 | SWORDSMEN ARE FIGHTING...
원문 | ...THAT GUY WITH THE CAPE...
원문 | HE LOOKS LIKE ME...)
```
...
```
원문 | (IT'S THE "STREET LEGEND."
원문 | KEENU'S PLAYING ON THE OTHER
원문 | SIDE.)
원문 | 
원문 | TAKE HER ON?
원문 | {0D}
...
```
원문 | BOY
원문 | SWISH BONK BONK SWISH
원문 | (HE'S ABSORBED IN GAME...)
```
...
```
원문 | GAME FREAK
원문 | BANG BANG CLICK CLICK
원문 | (ATTACK FROM A DODGE!
원문 | THE OPPONENT'S SEEING STARS!)
```
...
```
원문 | (IT'S A CRANE GAME...
원문 | CARDS ARE IN CAPSULES.)
원문 | PLAY THE CRANE GAME?
원문 | {0C}
```
...
```
원문 | (RYU'S POSTER IS HANGING.
원문 | IT'S AN ILLUSTRATION
원문 | DRAWN BY AKIMAN...
원문 | IT LOOKS REAL COOL...)
```
...
```
원문 | (IT'S CALLED "BURNING
원문 | BUCCANEER"...
원문 | GOT TO CHECK IT OUT LATER.)
```
...
```
원문 | (HEY, NEO CARNIVAL...
원문 | SURE HAS BIG STUFFED ANIMALS.
원문 | ...HOW DO YOU PICK THOSE UP?!)
```
...
### `071858`  51 → 54바이트  (빈 곳으로 옮겨 담음)

```
원문 | (HEY, NEO CARNIVAL...
원문 | IT HAS KEY HOLDERS AND TOYS.)
```
...
```
원문 | (HEY, NEO CARNIVAL...
원문 | IT HAS NEO MESSENGERS IN IT.
원문 | IT'S A DOLL YOU CAN
원문 | RECORD YOUR VOICE IN...)
```
...
원문 | POSTER
원문 | "OUT OF ORDER.
원문 | SORRY FOR THE INCONVENIENCE.."
```
...
```
원문 | YOU NEED AT LEAST 1 CARD
원문 | IN DECK TO GIVE 1 AWAY.
```
...
```
원문 | LINK PREPARATIONS COMPLETE?
원문 | 
원문 | IF PREPARATIONS COMPLETE,EITHER
원문 | PLAYER MUST PUSH "A" BUTTON.
```
...
### `070128`  43 → 45바이트  (빈 곳으로 옮겨 담음)

```
원문 | LINK ERROR. CHECK CONNECTIONS
원문 | AND SETTINGS.
```
...
### `070130`  83 → 91바이트  (빈 곳으로 옮겨 담음)

```
원문 | SAVE ERROR OCCURRED.
원문 | 
원문 | TO PREVENT "SAVED
원문 | DATA" DELETION,
원문 | CHOOSE "SAVE" 
...
### `07013C`  24 → 30바이트  (빈 곳으로 옮겨 담음)

```
원문 | " {0A} " CARD
원문 | GOT FROM {09}{7F}{7F}.
```
...
### `070150`  42 → 44바이트  (빈 곳으로 옮겨 담음)

```
원문 | NO-BET CARD BATTLE!
원문 | GET A CARD IF YOU WIN.
```
...
### `070154`  20 → 22바이트  (빈 곳으로 옮겨 담음)

```
원문 | HOT CARD-BET BATTLE!
```
...
### `070158`  46 → 54바이트  (빈 곳으로 옮겨 담음)

```
원문 | THRILLING CARD BATTLE!
원문 | CARD-BETS SET RANDOMLY.
```

```
번역 | 아슬아슬한 카드 대전!
번역 | 거는 카드는 무작위로 정해집니다.
```

### `07015C`  62 → 69바이트  (빈 곳으로 옮겨 담음)

```
원문 | EXHIBITION MATCH BEGINS.
원문 | 
원문 | WINNER GETS A CARD
원문 | CHOSEN AT RANDOM!
```
...
### `070160`  41 → 46바이트  (빈 곳으로 옮겨 담음)

```
원문 | NORMAL MATCH BEGINS.
원문 | HOT CARD-BET BATTLE!
```
...
```
원문 | SORRY, {08}, YOU
원문 | DON'T HAVE ENOUGH CARDS.
원문 | YOU NEED AT LEAST 1
원문 | MORE CARD IN YOUR DECK.
```
...
### `07016C`  75 → 85바이트  (빈 곳으로 옮겨 담음)

```
원문 | BOTH CARDS ARE READY.
원문 | 
원문 | WIN TO GET RIVAL'S CARD.
원문 | LOSE AND YOUR CARD'S TAKEN.
```
...
### `07017C`  152 → 161바이트  (빈 곳으로 옮겨 담음)

```
원문 | DEATH MATCH TO BEGIN.
원문 | 
원문 | LOSER LOSES 1 CARD
원문 | IN DEATH MATCHES.
원문 | THE PRIZE CARD IS RANDOMLY
원문 | CHOSEN FROM DECK IN USE.
원문 | SELECTED CARDS UNKNOWN
원문 | UNTIL MATCH ENDS.
```
...
```
원문 | LET THE MATCH BEGIN!
원문 | GOOD LUCK TO YOU BOTH!
```
...
```
원문 | SORRY, {09} DOESN'T
원문 | HAVE ENOUGH CARDS.
원문 | YOU NEED AT LEAST 1 MORE
원문 | CARD IN YOUR DECK.
```
...
### `0701C4`  27 → 28바이트  (빈 곳으로 옮겨 담음)

```
원문 | CHOOSE CARD FOR CARD PRIZE.
```
...
### `0701CC`  50 → 58바이트  (빈 곳으로 옮겨 담음)

```
원문 | OKAY TO SEND
원문 | CARD ALBUM DATA.
원문 | TO EACH NG POCKET?
원문 | {0C}
```
...
### `0701D4`  38 → 40바이트  (빈 곳으로 옮겨 담음)

```
원문 | CARD ALBUM DATA
원문 | TRANSMISSION FAILED...
```
...
### `0701F0`  92 → 109바이트  (빈 곳으로 옮겨 담음)

```
원문 | LINK ERROR.
원문 | VS MODE CANCELLED.
원문 | TO PREVENT "SAVED
원문 | DATA" DELETION,
원문 | CHOOSE "SAVE" 
원문 | IN THE MENU.
...
### `070200`  59 → 68바이트  (빈 곳으로 옮겨 담음)

```
원문 | DATA FROM VS MODE
원문 | WITH {09} REMAINS.
원문 | BEGIN GAME FROM BATTLE?
원문 | {0C}
```
...
### `070204`  37 → 40바이트  (빈 곳으로 옮겨 담음)

```
원문 | BATTLE DATA WILL BE DELETED?
원문 | 
원문 | OKAY?
원문 | {0D}
```
...
### `070208`  20 → 23바이트  (빈 곳으로 옮겨 담음)

```
원문 | CHOOSE DESIRED CARD.
```
...
```
원문 | GIVE-AWAY CARD DESIRED CARD
```
...
### `07023C`  36 → 37바이트  (빈 곳으로 옮겨 담음)

```
원문 | CHOOSE CARD TO PUT
원문 | IN TRADE MACHINE.
```
...
### `070280`  70 → 82바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU MUST SET
원문 | YOUR "COM NO."
원문 | ENTER THE "COM NO."
원문 | WITH "SET COM" OPTION.
```
...
```
원문 | ENTER YOUR FRIEND'S
원문 | COM UNIT SERIAL NUMBER.
```
...
```
원문 | YOU MUST ENTER YOUR
원문 | FRIEND'S SERIAL NUMBER.
```
...
### `070294`  24 → 27바이트  (빈 곳으로 옮겨 담음)

```
원문 | INITIALIZING COM UNIT...
```
...
### `07029C`  31 → 38바이트  (빈 곳으로 옮겨 담음)

```
원문 | {0E} COM UNITS
원문 | AVAILABLE FOR LINK.
```
...
### `0702B0`  36 → 50바이트  (빈 곳으로 옮겨 담음)

```
원문 | USING COM UNIT.
원문 | MUST ENTER "COM NO."
```
...
### `0702BC`  37 → 38바이트  (빈 곳으로 옮겨 담음)

```
원문 | IF CHANGE IS OK,
원문 | PUSH THE "A" BUTTON.
```
...
```
원문 | WHEN PREPARATIONS ENDED,EITHER
원문 | PLAYER MUST PUSH "A" BUTTON.
```
...
```
원문 | HP HANDICAP ADDED
원문 | ACCORDING TO CARD'S RARITY.
원문 | ADD HANDICAP?
원문 | {0C}
```
...
```
원문 | CHOOSE CARD TO STAY IN PILE
원문 | {0E} NO.
```
...
```
원문 | CHOOSE CARD TO RETURN TO PILE
원문 | REMAINING {0E} CARDS
```
...
### `070480`  21 → 23바이트  (빈 곳으로 옮겨 담음)

```
원문 | CHOOSE AC CARD TO USE
```
...
### `070484`  20 → 22바이트  (빈 곳으로 옮겨 담음)

```
원문 | CHOOSE EFFECT TO USE
```
...
### `070494`  26 → 27바이트  (빈 곳으로 옮겨 담음)

```
원문 | CHOOSE CARD TO ADD TO HAND
```
...
### `07049C`  30 → 33바이트  (빈 곳으로 옮겨 담음)

```
원문 | CHOOSE CARD TO REARRANGE
원문 | {0E} NO.
```
...
```
원문 | AC CARDS CAN'T BE
원문 | USED IN THIS TURN!
```
...
### `0704B0`  37 → 38바이트  (빈 곳으로 옮겨 담음)

```
원문 | "{17}" DISABLED BY
원문 | "SOMMERSAULT" EFFECT!
```
...
```
원문 | THIS CHARACTER CAN'T COUNTER!
```
...
```
원문 | CHARACTER COUNTER!
원문 | STOPPED BY \ABILITY
```
...
### `0704C0`  23 → 27바이트  (빈 곳으로 옮겨 담음)

```
원문 | CAN'T ATTACK THIS TURN!
```
...
```
원문 | CHARACTER'S ATTACK
원문 | DISABLED BY \ABILITY!
```
...
### `070524`  17 → 18바이트  (빈 곳으로 옮겨 담음)

```
원문 | {08}'S SP FELL BY {0E}!
```
...
### `070528`  17 → 18바이트  (빈 곳으로 옮겨 담음)

```
원문 | {09}'S SP FELL BY {0E}!
```
...
### `07055C`  17 → 18바이트  (빈 곳으로 옮겨 담음)

```
원문 | {08}'S PILE CHANGED!
```
...
### `070560`  17 → 18바이트  (빈 곳으로 옮겨 담음)

```
원문 | {09}'S PILE CHANGED!
```
...
### `070584`  17 → 18바이트  (빈 곳으로 옮겨 담음)

```
원문 | {08}'S HAND CHANGED!
```
...
### `070588`  17 → 18바이트  (빈 곳으로 옮겨 담음)

```
원문 | {09}'S HAND CHANGED!
```
...
### `0705C8`  21 → 23바이트  (빈 곳으로 옮겨 담음)

```
원문 | ALL CHARACTERS KO'ED!
```
...
### `0705D0`  21 → 28바이트  (빈 곳으로 옮겨 담음)

```
원문 | BOTH PLAYERS LOST SP!
```
...
### `0705D8`  20 → 21바이트  (빈 곳으로 옮겨 담음)

```
원문 | OWN CHARACTER KO'ED!
```
...
```
원문 | {08} ADDS ALL
원문 | Q-BEE CARDS IN PILE TO HAND.
```

```
번역 | {08} 더미의
번역 | Q비 카드를 모두 손패에 더한다.
```
...
```
원문 | {08} ADDS 
원문 | JURI AND JUNI CARDS TO HAND.
```

```
번역 | {08}
번역 | 율리와 유니 카드를 손패에 더한다.
```
...
```
원문 | CHOOSE CHARACTER TO STAY IN
원문 | RING.(YOUR CHARACTER)
```
...
### `07062C`  39 → 44바이트  (빈 곳으로 옮겨 담음)

```
원문 | EACH PLAYER DISCARDS
원문 | CHA CARDS IN HAND.
```
...
```
원문 | (PORTRAIT OF A CUTE WOMAN...)
원문 | 
원문 | ({7F}{7F}{7F}{7F}{7F})
원문 | 
원문 | (...TAKE ANOTHER LOOK)
```
...
원문 | SHIN
원문 | "What's up?
원문 | ...A blue-haired stuck-up guy?
원문 | Oh yeah, he was just over there.
원문 | He said he'd join the CARD CLASH
원문 | if it cost him everything.
원문 | He's at the tournament now.
원문 | I'm certain of it...
원문 | And if you win here at 'JOY JOY,'
원문 | the toy shop 'LOST WORLD,'
원문 | the game centers 'NEOGEO LAND,'
원문 | and 'PLAZA CAPCOM'...
원문 | Also the 'SC PARK' horror
원문 | attraction,
원문 | 'RESIDENT EVIL MANSION.'
원문 | If you win card battles at those
원문 | 5 places, you can get SC coins.
원문 | You can get coins in any order.
원문 | So go wherever you want.
원문 | Of course, I'll be playing, too.
원문 | Whoops! Gotta see the Kid.
원문 | Take it easy."
```
...
번역 | 게임 센터 '네오지오 랜드'하고
번역 | '플라자 캡콤'…
번역 | 또 'SC 파크'의 공포 놀이 시설
번역 | '바이오하자드 저택'.
번역 | 이 다섯 곳에서 카드 대전을
번역 | 이기면 SC 코인을 받을 수 있어.
번역 | 코인은 아무 순서로나 모아도 돼.
번역 | 그러니 가고 싶은 데로 가.
번역 | 물론 나도 나갈 거야.
번역 | 앗! 키드를 만나러 가야겠다.
번역 | 수고해."
...
원문 | CAP
원문 | "What's the word?
원문 | ...Oh yeah, you're going to
원문 | join the CARD CLASH tourney?
원문 | Then I'll tell you the 5 places
원문 | it's going to be held.
원문 | First there's 'LOST WORLD' here.
원문 | Then the card shop 'JOY JOY.'
원문 | After that, there's...
원문 | 'NEOGEO LAND' and 'PLAZA
원문 | CAPCOM.'
원문 | Then the attraction 'RESIDENT
원문 | EVIL MANSION'
원문 | in the amusement complex,
원문 | 'SC PARK.'
원문 | ...Those 5 places.
원문 | When you win a card game,
원문 | you can earn SC coins. Got it?
원문 | You can gather coins in
원문 | any order you like....
원문 | ...Well, Fo's waiting for me.
원문 | Good luck! See you around."
```
...
원문 | MELLO-AKI
원문 | "Woe's me...
원문 | How come Cham Cham
원문 | can't back up Hayate?
원문 | I don't get it..."
```
...
### `0719AC`  52 → 54바이트  (빈 곳으로 옮겨 담음)

```
원문 | MELLO-AKI
원문 | "That's it!
원문 | 'APPLE.'
원문 | 'APPLE' is the link."
```
...
```
원문 | TEEN
원문 | "Hey, in that game center,
원문 | the one over there has
원문 | a HYPER NEOGEO 64 game!
원문 | It's got a little monitor, so I bet
원문 | it spits out a lot of electricity."
```
...
```
원문 | BIDDER
원문 | "This auction's got
원문 | scads of rare art.
원문 | But everyone wants it,
원문 | so it will be hard to get."
```
...
```
원문 | TAKA
원문 | "I've been waiting for you,
원문 | {08}.
원문 | We're getting up on the stage!"
```
...
```
원문 | KANA
원문 | "So...the last contestant is here.
원문 | Please get up on stage."
```
...
```
원문 | RECEPTIONIST
원문 | "Welcome to NEOGEO World.
원문 | {08}
원문 | 
원문 | Are you ready for the
원문 | semifinals?"
원문 | ARE ALL PREPARATIONS MADE?
원문 | {0D}
```
...
### `0719CC`  86 → 99바이트  (빈 곳으로 옮겨 담음)

```
원문 | RECEPTIONIST
원문 | "Welcome to NEOGEO World.
원문 | All events are being held now.
원문 | Enjoy yourself."
```
...
```
원문 | BYTE
원문 | "Come on up to the Pao Pao Cafe.
원문 | ...Later that is.
원문 | We're preparing for the opening.
원문 | Come back here, you hear?"
```
...
원문 | CLERK
원문 | "May I help you?
원문 | ...Well shut my mouth!
원문 | It's the Champion.
원문 | Yikes! Hey, hey!
원문 | Can I have your autograph?"
```
...
원문 | CLERK
원문 | "May I help You?
원문 | We're renting the 
원문 | NEOGEO Pocket now.
원문 | You can rent these titles:
원문 | 'SVC BATTLE,' 'MEGAMAN Z,'
원문 | 'KOF-ROUND 5,' and 'ROOSTERS 2.'
원문 | That's 4 titles!
원문 | ...Too bad, though.
원문 | They're all rented out.
원문 | Sorry about that."
```
...
```
원문 | GIRL
원문 | "Hey, don't push me!
원문 | You don't have to get pushy
원문 | just because it's so crowded!
원문 | But wow! How about No Fate?
원문 | Sure is popular, huh?"
```
...
```
원문 | GIRL
원문 | "Peep Gem is right ahead.
원문 | I've been waiting forever...
원문 | I can't get in at all."
```
...
```
원문 | TAKA
원문 | "Whoo! The semifinals!
원문 | The 4 who got this far
원문 | are all gunning for the finals.
원문 | One's going for sure!
원문 | He's headed for Las Vegas...
원문 | where the finals will be held.
원문 | Who do you think'll be the other?
원문 | Just 3 games and, 'Hello, Las
원문 | Vegas.'
원문 | Who's first?..."
원문 | The first players are...
원문 | The Kid and...{08}!
원문 | Approach your table!"
```
...
```
원문 | TAKA
원문 | "Your next opponent is...
원문 | Comet!
원문 | Best of luck to you both!"
```
...
원문 | "Your next opponent is...
원문 | ...Kei!
원문 | The winner goes to Las Vegas."
```
...
원문 | "It's all over!
원문 | It's {08}
원문 | who's going to Las Vegas!"
원문 | So pack your bags, pal,
원문 | and rush to the airport!"
```
...
```
원문 | KANA
원문 | "It's the Annual CARD CLASH
원문 | Semifinals game.
원문 | It's finally here.
원문 | These 4 remaining players
원문 | will fight to go to the finals.
원문 | One winner has been decided.
원문 | And he's heading for Las Vegas,
원문 | where the finals will be held.
원문 | Who will be the other?
원문 | Just 3 games to Las Vegas.
원문 | Now, the first game...
원문 | The players are...
원문 | Fo and...
원문 | {08}.
원문 | Approach your table!!"
...
```
원문 | KANA
원문 | "The winner of the semifinals
원문 | is...
원문 | {08}!
원문 | The arrangements are made.
원문 | Now go to the airport!"
```
...
### `071A14`  72 → 79바이트  (빈 곳으로 옮겨 담음)

```
원문 | BARTENDER
원문 | "Welcome!
원문 | We got a new game...
원문 | it's 'BEAST BUSTERS-DARK ARM.'"
```
...
번역 | "어서 오세요!
번역 | 새 게임이 들어왔어요…
번역 | "비스트 버스터즈 - 다크 암"이에요."
```

### `071A18`  100 → 103바이트  (빈 곳으로 옮겨 담음)

```
원문 | GIRL
원문 | "I'm terrible at NEO Carnival.
원문 | I can only get 2 prizes with a
원문 | coin.
원문 | My friend always gets 4..."
```
...
원문 | TSUKADA
원문 | "Eat this, Zombie!
원문 | 'Rat a ta ta rat tata rat a tata
원문 | rat a ta ta rat a tata rat a tata
원문 | rat a ta ta rat a tata rat a tata
원문 | rat a ta ta rat a tata rat a tata
원문 | rat a ta ta rat a tata rat a tata
원문 | rat a ta ta rat a tata rat a tata
...
원문 | 
원문 | ...Sorry.
원문 | Got a bit carried away there."
```
...
```
원문 | BOY
원문 | "Yes, I cleared 'Ikari 4!'
원문 | Next, 'Psycho Soldier DX.'
원문 | Coming to get you, 'Psycho!'"
```
...
```
원문 | GIRL
원문 | "Just as I thought, a quiz game.
원문 | 'Quiz Detectives Pure & Fare'!
원문 | This looks interesting."
```
...
원문 | MURASE
원문 | "Collecting cards?
원문 | It's really hard to get
원문 | cards with high RARITY, huh?
원문 | Don't give up. One card at a time
원문 | is the key to card collecting."
```
...
```
원문 | GAME FREAK
원문 | "Have you played this game?
원문 | 'Ultimate Ghouls & Ghosts?'
원문 | It's a 100 times cooler!
원문 | And a 100 times harder!
원문 | I can't get enough of it!"
```
...
```
원문 | (A NEO CARNIVAL...IN THE
원문 | CAPSULES!
원문 | CARDS YOU'VE NEVER SEEN
원문 | BEFORE!)
원문 | PLAY NEO CARNIVAL?
원문 | {0C}
```
...
```
원문 | (IT'S HARD TO GET AT...)
원문 | 
원문 | PUSH THE LUCKY MIX BUTTON?
원문 | {0D}
```
...
```
원문 | (NOW IT'S HARDER TO GET!
원문 | ...FIRST I'LL GO RIGHT. )
원문 | MOVE CRANE WIDE TO RIGHT?
원문 | {0D}
```
...
### `071A3C`  71 → 75바이트  (빈 곳으로 옮겨 담음)

```
원문 | (AH, FORGET THAT...
원문 | {7F}FIRST MOVE RIGHT.)
원문 | MOVE CRANE A LITTLE TO RIGHT?
원문 | {0D}
```
...
번역 | (아, 그건 됐고…
번역 | {7F}먼저 오른쪽으로 가자.)
번역 | 크레인을 조금 오른쪽으로 옮길까?
번역 | {0D}
```

### `071A40`  54 → 57바이트  (빈 곳으로 옮겨 담음)

```
원문 | (NEXT, MOVE TO THE BACK.)
원문 | 
원문 | MOVE CRANE A BIT FORWARD?
원문 | {0D}
```
...
```
원문 | (YOU BARELY GOT THE CAPSULE!
원문 | IT LOOKS LIKE IT'LL FALL!)
원문 | PRAY IT DOESN'T FALL?
원문 | {0D}
```
...
```
원문 | (YOU NAILED THAT CAPSULE!
원문 | IT LOOKS LIKE IT'S YOURS!)
원문 | HUM A VICTORY SONG?
원문 | {0D}
```
...
### `071A50`  72 → 74바이트  (빈 곳으로 옮겨 담음)

```
원문 | (MANAGED TO GET CAPSULE.
원문 | MIGHT FALL, MIGHT NOT.)
원문 | PRAY IT DOESN'T FALL?
원문 | {0D}
```
...
```
원문 | (TOO BAD! THE CAPSULE FELL!
원문 | OR SO IT SEEMS{7F}
원문 | IT JUST FELL IN THE PRIZE CHUTE!!
원문 | OPEN THE CAPSULE!)
```
...
```
원문 | (CRANE DROPPED THE CAPSULE
원문 | ON THE SHAKE COVER.)
```
...
```
원문 | (IT LOOKED LIKE YOU GOT IT
원문 | BUT THE ARM, THE SHAKE COVER...
원문 | THE CAPSULE FELL!)
```
...
```
원문 | INABA
원문 | "You listening, Nakamura?
원문 | I want a 'MORRIGAN' card.
원문 | Go get it for me."
원문 | NAKAMURA
원문 | "Gah! I'm in trouble...
원문 | You can't squeeze blood
원문 | from a mouse...No, wait..."
```
...
원문 | NAKAMURA
원문 | "Hey, you!
원문 | Got a 'MORRIGAN' card?
원문 | I'm begging you! Bring me one!
원문 | If you bring me one, I'll trade
원문 | a 'TRI-QUIZ' card for it."
원문 | GIVE AWAY "MORRIGAN"?
원문 | {0D}
```
...
```
원문 | NAKAMURA
원문 | "Inaba, I got 'MORRIGAN.'
원문 | This is it, right?"
원문 | 
원문 | INABA
원문 | "Yeah, good job. Now next I...
원문 | NAKAMURA
원문 | "Say what? Another one?
원문 | I'm exhausted!"
```
...
```
원문 | NAKAMURA
원문 | "Hey, got a 'MORRIGAN?'
원문 | And don't try to trick me!"
원문 | 
원문 | INABA
원문 | "NA-KA-MU-RA!
원문 | NAKAMURA
...
### `071A7C`  31 → 32바이트  (빈 곳으로 옮겨 담음)

```
원문 | NAKAMURA
원문 | "Save you, my behind!"
```
...
```
원문 | NAKAMURA
원문 | "Thanks for the favor.
원문 | But Inaba's on my back.
원문 | Talk about selfish!..."
원문 | INABA
원문 | "Just what did you say?!"
```
...
### `071A8C`  40 → 43바이트  (빈 곳으로 옮겨 담음)

```
원문 | INABA
원문 | "Nakamura!
원문 | Where's my 'MORRIGAN'?"
```
...
원문 | INABA
원문 | "Nakamura!
원문 | Where's my software present?
원문 | I've been waiting for ages."
```

```
번역 | 이나바
번역 | "나카무라!
번역 | 내 소프트웨어 선물은 어디 있나?
번역 | 한참을 기다렸다."
```
...
```
원문 | RECEPTIONIST
원문 | "The finals are at the SC Hotel.
원문 | Just go down the stairs,
원문 | and then to the airport.
원문 | Good luck in Las Vegas."
```
...
### `071A9C`  56 → 57바이트  (빈 곳으로 옮겨 담음)

```
원문 | GIRL
원문 | "Hey, no fair!
원문 | Hey, buddy!
원문 | You can't butt in here!"
```
...
```
원문 | (IT'S NEO CARNIVAL...
원문 | 
원문 | IT'S FILLED WITH THE
원문 | A CHICK DOLL.)
```
...
### `071AA8`  77 → 82바이트  (빈 곳으로 옮겨 담음)

```
원문 | (IT'S NEO CARNIVAL...
원문 | HEAVY-LOOKING ROBOTS INSIDE.
원문 | {7F}CAN THE CRANE GRAB THEM?)
```

```
번역 | (네오 카니발이다…
번역 | 무거워 보이는 로봇이 들어 있다.
번역 | {7F}크레인이 저걸 집을 수 있을까?)
```
...
원문 | (IT'S 'BEAST BUSTERS-DARK ARM'!
원문 | 
원문 | A LOT OF ZOMBIES ARE IN IT
원문 | IT'S A GUN SHOOTING GAME.)
```
...
### `071AB0`  70 → 84바이트  (빈 곳으로 옮겨 담음)

```
원문 | (IT'S 'STREET FIGHTER ALPHA 2.'
원문 | I FORGOT HOW TO...
원문 | ...GET 'EVIL RYU.')
```
...
```
원문 | (IT'S 'STREET FIGHTER ALPHA 2'!
원문 | WONDER IF ANYONE'LL TAKE ME
원문 | ON?)
```
...
원문 | BIDDER
원문 | "Do you know Mask
원문 | A strange guy in a white mask.
원문 | Gotta love that guy!
원문 | He always has a load
원문 | of really great cards!"
```
...
```
원문 | BIDDER
원문 | "Come to think of it,
원문 | I got an awesome card.
원문 | But the Trading Machine
원문 | isn't working so well.
원문 | You can belt it, though
원문 | My Mommy said it's OK."
원문 | 
```
...
```
원문 | BIDDER
원문 | "You know the last battle...
원문 | I would have probably
원문 | used an AC card then.
원문 | You got talent, kid.
원문 | But you're still green!"
```
...
```
원문 | BIDDER
원문 | "I come here once in a while.
원문 | I heard there's going to be
원문 | a rare card auction today.
원문 | Today's our lucky day, huh?"
```
...
```
원문 | BIDDER
원문 | "You know something?
원문 | There's a crane game,
원문 | and it's filled with rare cards.
원문 | If I ever find it, I'll get them,
원문 | no matter how much it costs.
```
...
```
원문 | INFORMATION COUNTER
원문 | "To dazzle your senses,
원문 | a super attraction!
원문 | NEOGEO World, Tokyo Bayside!
원문 | In Agora Square!
원문 | Our auction begins!"
```
...
원문 | INFORMATION
원문 | "NO FATE.
원문 | A mystery attraction
원문 | tie-up with 'Wake Up, Morning,'
원문 | XYZ Network's popular show."
```
...
```
원문 | GALLERY
원문 | "Are you going to the auction?
원문 | What auction, you say?
원문 | The Rare Card auction, of course!
원문 | The person who trades the best
원문 | card,
원문 | can get a better rare card."
```
...
원문 | DOORMAN
원문 | "{08}...
원문 | Sorry to keep you waiting.
원문 | This is SNK and CAPCOM's
원문 | massive amusement hotel,
원문 | the luxurious SC Hotel!
원문 | The finals begin soon.
원문 | Please, follow me in!"
```
...
```
원문 | DOORMAN
원문 | "Welcome to the SC Hotel.
원문 | We're holding the finals
원문 | inside right now.
원문 | Enjoy yourself and good luck."
```
...
```
원문 | BUNNY
원문 | "Finally, the Finals!
원문 | When you're ready,
원문 | go to the elevator."
```
...
```
원문 | GUEST
원문 | "Hey, you're a finalist.
원문 | Good luck in there,
원문 | I'm rooting for you."
```
...
```
원문 | GUEST
원문 | "Good game. Congrats!
원문 | What's your next goal?
원문 | Filling your card album?"
```
...
원문 | BELLBOY
원문 | "Welcome!
원문 | This photo exhibit shows
원문 | previous finalist winners!"
```
...
```
원문 | (PICTURE OF "SNEAKER",
원문 | WINNER OF 1ST SC CARD CLASH.)
```
...
```
원문 | (PICTURE OF "CABBY",
원문 | WINNER OF 2ND SC CARD CLASH.)
```
...
```
원문 | (A VICTORY PICTURE.
원문 | IT LOOKS REALLY COOL.)
원문 | (DO YOU REMEMBER THE ENDING?)
원문 | 
원문 | AFTER ENDING, GAME DATA
원문 | WILL BE SAVED.
원문 | SAVE DATA?
원문 | {0D}
```
...
### `071B24`  64 → 66바이트  (빈 곳으로 옮겨 담음)

```
원문 | (ELEVATOR DOOR.
원문 | FINALS ARE BEING HELD NOW.)
원문 | RIDE THE ELEVATOR?
원문 | {0D}
```
...
원문 | YOSIKI
원문 | "Welcome!
원문 | It's the CARD CLASH Finals!
원문 | I'm Yosiki, your announcer!
원문 | NISHI
원문 | "I'm Nishi.
원문 | {08}, you did well
원문 | coming this far."
원문 | YOSIKI
원문 | "But if you lose the finals...
원문 | everything is for naught!
원문 | Stay sharp to the end!"
원문 | NISHI
원문 | "Well, then
원문 | Here's your opponent, Cap!
원문 | However..."
원문 | YOSIKI
원문 | "Quiet. He's already here!"
```
...
원문 | NISHI
원문 | "For your prize...
원문 | I present you with this card."
원문 | 
원문 | YOSIKI
원문 | "It's a super-rare card!"
```
...
원문 | NISHI
원문 | "Good win!
원문 | Good luck hereafter!
원문 | Conquer the CARD CLASH!"
원문 | YOSIKI
원문 | "Oh yeah...
원문 | I still have more cards...
원문 | ...uh, I thought I did.
원문 | NISHI
원문 | "Until we meet again!"
원문 | YOSIKI
원문 | "Take care!"
```
...
```
원문 | WOMAN
원문 | "Ooh hoo hoo. You're cute!
원문 | Are you in the finals?
원문 | I'd like to be your fan...
원문 | But that guy's my type, too.
원문 | I just can't decide!..."
```
...
```
원문 | WOMAN
원문 | "Oooh! You're in the finals?
원문 | But, oh, your opponent...
원문 | He's so strong! Can you win?"
```
...
원문 | WOMAN
원문 | "You did it, huh?
원문 | I always wanted you to win.
원문 | I cheered for you so hard!
원문 | ...Really, I'm serious!"
```

```
번역 | 여자
번역 | "해내셨네요?
번역 | 저는 늘 당신이 이기길 바랐어요.
번역 | 얼마나 응원했는데요!
번역 | …정말이에요, 진심이라고요!"
```
...
원문 | 
원문 | YOSIKI
원문 | "But even though you won,
원문 | don't get lazy. I'm looking
원문 | forward to seeing you improve!"
원문 | NISHI
원문 | We're holding a tournament
원문 | here at the SC Hotel.
원문 | It's an elimination match."
원문 | YOSIKI
원문 | "How about it. Will you join?
원문 | If you beat 4 players,
원문 | you get a rare card."
원문 | JOIN THE TOURNAMENT?
원문 | {0D}
```
...
```
원문 | NISHI
원문 | "Let the tournament begin!
원문 | YOSIKI
원문 | "Let the first players come
원문 | forward!"
```
...
```
원문 | NISHI
원문 | "Oh really? ...Too bad."
원문 | YOSIKI
원문 | "Call us if you change your
원문 | mind."
```
...
### `071B5C`  60 → 62바이트  (빈 곳으로 옮겨 담음)

```
원문 | NISHI
원문 | "Gee, that's too bad."
원문 | YOSIKI
원문 | "Try again. No regrets!"
```
...
원문 | "Hey, {08}."
원문 | YOSIKI
원문 | "We're holding a one-round
원문 | elimination tournament.
원문 | We're making arrangements now!"
원문 | NISHI
원문 | "Can you wait just a bit?"
```
...
```
원문 | YOSIKI
원문 | "We're always holding a
원문 | tournament."
원문 | 
원문 | NISHI
원문 | "We're looking forward to you
원문 | join!"
```
...
원문 | YOSIKI
원문 | "Welcome...
원문 | to the SC CARD CLASH Tournament!
원문 | I'm your announcer, Yosiki..."
원문 | NISHI
원문 | "And I'm Nishi!
원문 | {08}, you've come far."
원문 | 
원문 | YOSIKI
원문 | "But if you don't win the finals...
원문 | your efforts are all for naught!
원문 | Stay sharp till the tournament
원문 | ends!"
원문 | 
원문 | NISHI
원문 | "OK,
원문 | your opponent's Shin.
원문 | But..."
원문 | YOSIKI
원문 | "In fact, here he is!"
```
...
원문 | "Welcome, {08}!"
원문 | YOSIKI
원문 | "In this tournament, you
원문 | must eliminate all newcomers.
원문 | It's survival of the fittest!"
원문 | NISHI
원문 | "If you beat 20 players,
원문 | you win a number of cards
원문 | as a prize for your efforts."
원문 | JOIN THE TOURNAMENT?
원문 | {0D}
```
...
```
원문 | YOSIKI
원문 | "Hey, no time to rest!
원문 | Bring on the next player!"
```
...
```
원문 | RICHARD
원문 | "Welcome to Pao Pao Cafe 3!
원문 | It took time to open this place...
원문 | but I'm offering a lot of freebies!
원문 | So make yourself at home here!"
```
...
```
원문 | RICHARD
원문 | "That was one hot match!
원문 | It takes me back to my
원문 | old days of battle!"
```
...
```
원문 | HIMEJI
원문 | "Hey, dudes, call me, Himeji!
원문 | I'm taken with this place.
원문 | The Capoella show is superb!
원문 | Ooh, listen to that!
원문 | What groovy rhythm!"
```
...
```
원문 | HIMEJI
원문 | "How about that? Cool, huh?
원문 | All this place needs now is some
원문 | dancing girls and it can't be
원문 | beat!"
```
...
### `071B90`  74 → 77바이트  (빈 곳으로 옮겨 담음)

```
원문 | CAPOELLAS
원문 | "Hey, we're the Capoellas!
원문 | Want real music? Then we're for
원문 | you!"
```
...
```
원문 | SHIMEJI
원문 | "Welcome to our club!
원문 | You can call me, Shimeji.
원문 | I work at this club.
원문 | What can I get you?
원문 | Some juice? Salsa?"
```
...
```
원문 | MISTER
원문 | "When trading cards,
원문 | you can trade using the
원문 | 'GIVE CARD' mode, too.
원문 | But just getting cards
원문 | is a bit selfish, you think?"
```
...
```
원문 | YOUNG GUY
원문 | "That's mighty fine coffee.
원문 | Try the rich-brewed taste!"
```
...
```
원문 | YOUNG LADY
원문 | "Heard of a guy named Yosiki?
원문 | I meet up with him so many times.
원문 | What do you think that guy does?"
```
...
```
원문 | BOY
원문 | "It's the champ, {08}!
원문 | Wow! Cool! It's really you!"
```
...
```
원문 | AN-CHAN
원문 | "For cards you can't get...
원문 | try trading with a friend.
원문 | 'Give-and-take' is the secret.
원문 | Some cards can only be gotten
원문 | by trading, you know!"
```
...
```
원문 | MISTER
원문 | "First, CARD CLASH is...
원문 | Hey! It's the champ!
원문 | I'll give you a tip.
원문 | About this CARD CLASH stuff,
원문 | I don't know diddley!"
```
...
```
원문 | MISTER
원문 | "Who needs AC cards?
원문 | You can attack with CHA cards!
원문 | Why don't people know this?
원문 | What a bunch of spuds!
원문 | 
원문 | (NOTE: CAREFULLY BALANCE
원문 | CHA CARDS WITH AC CARDS.)
```
...
```
원문 | MISTER
원문 | "Who needs CHA cards?
원문 | CHA cards are just to
원문 | build up SP!
원문 | AC cards are enough!
원문 | What a bunch of spuds!
원문 | (NOTE: CAREFULLY BALANCE
원문 | CHA CARDS WITH AC CARDS.)
```
...
```
원문 | THE CAPOELLAS
원문 | "How do we sound everyone?
원문 | Pretty groovin', huh?
원문 | 
원문 | Hey, have you heard?
원문 | There're over 300 cards,
원문 | and all of the cards
원문 | can't be gotten by one person!
원문 | If you want all 300 cards,
원문 | you'll need your friends' help!"
```
...
```
원문 | THE CAPOELLAS
원문 | "How' everyone feeling?
원문 | If you're dancin', you're smilin'!"
```
...
```
원문 | THE CAPOELLAS
원문 | "Hey, get out of the corners!
원문 | Everyone, dance with us!
원문 | If you're dancin', you're smilin'!"
```
...
```
원문 | YOSIKI
원문 | "You've beaten {0E} players!
원문 | Let the next opponent come on
원문 | down!"
```
...
```
원문 | GUEST
원문 | "Nice! Your album's complete!
원문 | There's loads of good stuff
원문 | with the Link Cable, huh?"
```
...
원문 | LAD
원문 | "Welcome, {08}.
원문 | This is a card trading shop.
원문 | I'll trade cards with you.
원문 | Here. Here's my card list!"
```
...
원문 | This is a card trading shop!
원문 | I'll trade cards with you.
원문 | ...But I just remembered.
원문 | I'm out of trading cards.
원문 | Why don't you kill some time,
원문 | and I'll get a new shipment.
원문 | Come back later!"
```
...
```
원문 | SYLPHY
원문 | "Ooh hoo hoo! Scare you?
원문 | This is a card trading shop.
원문 | 
원문 | Check out our catalog."
```
...
원문 | This is a card trading shop.
원문 | 
원문 | I'm terribly sorry!
원문 | I'm all out of cards now.
원문 | Please drop by later..."
```
...
```
원문 | CHRIS
원문 | "Whew! I beat those zombies!
원문 | I'm taking a breather now.
원문 | Oh, that reminds me!
원문 | I found this precious card
원문 | in this mansion here.
원문 | If you want, I'm willing to
원문 | trade. How about it?"
```
...
원문 | RARITY A cards."
원문 | ...But...What the...?
원문 | My cards, they were here!
원문 | Sorry. The zombies must 
원문 | have taken them while I rested.
원문 | But I'll get them back!
원문 | Drop by once again, civilian!"
```
...
```
원문 | CHRIS
원문 | "If you feel like it, drop by.
원문 | If the zombies don't get me,
원문 | I'm sure we'll meet up again!"
```
...
### `071C18`  27 → 30바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU'RE READY FOR LAS VEGAS.
```
...
```
원문 | TRADING MACHINE
원문 | "THIS IS A TRADING MACHINE.
원문 | IF YOU PUT 5 TO 10 CARDS IN,
원문 | YOU CAN GET 1 RANDOM CARD.
원문 | WARNING!
원문 | 
원문 | YOU WON'T GET YOUR CARDS
원문 | BACK."
원문 | USE THE MACHINE?
원문 | {0C}
```
...
### `071C4C`  21 → 22바이트  (빈 곳으로 옮겨 담음)

```
원문 | THANK YOU! TRY AGAIN!
```
...
```
원문 | TRADING MACHINE
원문 | "THiS Is A CArD TRAdINg MacHINE.
원문 | IF yOU PUT 5 To 10 CARDddS INnnn,
원문 | YOU CAN GET 1 RANDOM cccCARD.
원문 | WARNING!
원문 | 
원문 | YOU WON'T ggGET YOUR CCARDS
원문 | BACK.
원문 | usE THE MacHINNNNNNNNE?"
원문 | {0C}
```
...
```
원문 | GEEZER
원문 | "You're in trouble now!
원문 | I'm gonna give you a cleaning!"
```
...
원문 | GEEZER
원문 | "Huh? Oh yeah...
원문 | Guess it's an hallucination!
원문 | Sorry...
```
...
원문 | GEEZER
원문 | "Thunderations!----
원문 | You can't touch that!
원문 | Geez, kid's these days!"
```
...
원문 | (POP!)
원문 | 
원문 | (THE DUST DRAGON MOVES...
원문 | THEN STOPS SUDDENLY.)
```
...
```
원문 | BYTE
원문 | "Oh, man. It's broken!
원문 | Just a sec. I'll fix it...."
```
...
### `071CB0`  43 → 44바이트  (빈 곳으로 옮겨 담음)

```
원문 | BOY
원문 | "Is it broken?
원문 | Did I push it too much?"
```
...
```
원문 | BOY
원문 | "At last, it's fixed.
원문 | Oh boy! Now I can go
원문 | back to scaring people!"
```
...
```
원문 | BYTE
원문 | "Hmm. This goes here...And this...
원문 | ...uh...this cord...like this.
원문 | OK. It's going to take time...
원문 | to fix this up 100%."
```
...
원문 | BYTE
원문 | "Oh, it's you.
원문 | I finally fixed it!
원문 | But I want more time
원문 | to look at it so it
원문 | doesn't break again."
```
...
```
원문 | (...THERE'RE A LOT OF OLD BOOKS.
원문 | 
원문 | THEY LOOK TOUGH TO READ.
원문 | QUIT LOOKING AT THEM...)
```
...
```
원문 | (IT SAYS, "CRYSTALS AND
원문 | ELIXIRS."
원문 | SOME STRANGE MEDICINE'S INSIDE)
```
...
```
원문 | (HEAT-SEEKING MISSILES
원문 | CLUSTER BOMBS, NAPALM SHELLS.
원문 | ALL KINDS OF MISSILES INSIDE...
원문 | ...PROBABLY TOYS...)
```
...
```
원문 | (A LOT OF "KOF" DOLLS
원문 | ARE STUFFED INSIDE.)
```
...
```
원문 | (IN THIS ONE THERE'S
원문 | "STREET FIGHTER 2" ACTION
원문 | FIGURES.)
```
...
```
원문 | (IT LOOKS LIKE ACCESSORIES,
원문 | 
원문 | OLD SHOOTING GAMES...
원문 | ...STOCK FROM "LOST WORLD".)
```
...
```
원문 | SLOT MACHINE
원문 | INSERT 1 "RARITY D"
원문 | CARD PLEASE.
원문 | LINE UP 3 MARKS
원문 | AND YOU'LL GET
원문 | A LOT MORE CARDS BACK.
원문 | PLAY THE SLOT MACHINE?
원문 | {0C}
```
...
```
원문 | (HMMM. THERE SHOULD
원문 | BE SOMETHING HERE...)
원문 | IS "LINK CABLE" ATTACHED?
원문 | {0D}
```
...
원문 | TAKA
원문 | "Whoo hee!
원문 | The semifinals are done.
원문 | But there's still the event
원문 | at Tokyo's NEOGEO WORLD!
원문 | 
원문 | There's an auction there,
원문 | and you can get rare cards!
원문 | I bet you want to go, huh?"
원문 | 
원문 | KANA
원문 | "I'll wager my
원문 | 'KYO (P)' card and
...
```
원문 | TAKA
원문 | "First, after a 'TERRY' card,
원문 | I'll offer this card.
원문 | Raise your hands!"
원문 | BIDDER
원문 | "Here!"
원문 | BIDDER
원문 | "Here's a 'TERRY' card!
원문 | BIDDER
원문 | "I got one, too!"
원문 | KANA
원문 | "Right from the start
원문 | we're in business. Does
원문 | anyone else have a 'TERRY'?"
원문 | SHOW "TERRY" CARD?
원문 | {0D}
```
...
원문 | 
원문 | KANA
원문 | "Bidding just ended
원문 | on 'KYO (P)' cards in
원문 | the gallery over there!"
원문 | TAKA
원문 | "Holy Disappointment!
원문 | This auction is
원문 | over for us!"
```
...
원문 | KANA
원문 | "Bidding just ended
원문 | on 'NAKORURU' cards in
원문 | the gallery over there!"
원문 | TAKA
원문 | "Hammana hammana!
원문 | Why in blazes did I
원문 | ever decide to come here?"
```
...
```
원문 | KANA
원문 | "Is there anyone else?
원문 | If there isn't
원문 | the bid goes to this person!"
원문 | BIDDER
원문 | ...
원문 | TAKA
원문 | "Oooghyaaa!
...
원문 | I'm white hot!
원문 | We did it, Kana!
원문 | Can't wait till next time!"
원문 | Whoo hyaaa!"
원문 | KANA
원문 | See you next time!"
```
...
```
원문 | KANA
원문 | "Sorry for the wait!
원문 | The Auction begins,
원문 | here at NEOGEO World Tokyo!
원문 | TAKA
원문 | "Whoo-hyah!
원문 | These cards are the rarest of the
원문 | rare!
원문 | Wow! A "EVIL RYU"!
```
...
```
원문 | KANA
원문 | "The one of all of you
원문 | who gives away the most cards,
원문 | gets a "EVIL RYU"!
원문 | TAKA
원문 | "First, let's begin with a
원문 | 'CHUN-LI' card.
원문 | All who can give up this card,
원문 | raise your hands!"
원문 | 
원문 | BIDDER
원문 | "I can!"
...
원문 | "Me too! Me too!!"
원문 | BIDDER
원문 | "I'll give up a 'CHUN-LI', too!"
원문 | KANA
원문 | "An instant favorite!
원문 | Is there anyone else willing
원문 | to pull a 'CHUN-LI' card?"
원문 | PULL 'CHUN-LI' CARD?
원문 | {0D}
```
...
```
원문 | TAKA
원문 | "Whoo hyaa! Good job!"
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'ANDY' card, too?
원문 | Is there anyone at all
원문 | who will give up both
원문 | cards?"
원문 | BIDDER
원문 | "Yes! I've got doubles!"
원문 | KANA
원문 | "Hmm. Will anyone else
원문 | give up this card?
원문 | Anyone at all?"
원문 | PULL "ANDY" CARD?
원문 | {0D}
```
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up another card?
원문 | Anyone else at all?"
원문 | PULL 'RYO' CARD?
원문 | {0D}
```
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'NAKORURU(T)'
원문 | card, too?
원문 | Is there anyone else
원문 | who will give up both cards?"
원문 | BIDDER
원문 | "Yes! Me! Me!"
원문 | KANA
원문 | "So, will anyone else
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'SHIZUMARU' card, too?
원문 | Is there anyone else
원문 | who will give up both cards?"
원문 | 
원문 | BIDDER
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'SOGETSU' card, too?
원문 | Is there anyone else
원문 | who will give up both cards?"
원문 | 
원문 | BIDDER
원문 | "It's not worth it, but OK."
원문 | KANA
원문 | "So, will anyone else
원문 | give up another card?
원문 | Anyone else at all?"
원문 | PULL "SOGETSU" CARD?
원문 | {0D}
```
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'BENIMARU' card, too?
원문 | Is there anyone else
원문 | who will give up both cards?"
원문 | 
원문 | BIDDER
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'AKARI (S)' card, too?
원문 | Is there anyone else
원문 | who will give up both cards?"
원문 | 
원문 | BIDDER
원문 | "......."
원문 | (LOOKS LIKE NO ONE WILL...) 
원문 | 
원문 | PULL "AKARI (S)" CARD?
원문 | {0D}
```
...
원문 | the bid goes to this person!"
원문 | BIDDER
원문 | "Yes! I want that card!"
원문 | KANA
원문 | "Oh, we have a bidder!"
원문 | TAKA
원문 | "Then added to the other cards,
원문 | here's a 'KAGAMI' card!
원문 | Anyone who'll give up
원문 | this one?
원문 | 
원문 | BIDDER
원문 | "......."
...
원문 | the bid goes to this person!"
원문 | BIDDER
원문 | "OK! I give up my card!"
원문 | KANA
원문 | "Oh, we have a bidder!"
원문 | TAKA
원문 | "Then added to the other cards,
원문 | here's a 'THE WANDERER' card!
원문 | Anyone who'll give up
원문 | this one?
원문 | 
원문 | BIDDER
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'GUY' card, too?
원문 | Is there anyone else
원문 | who will give up both cards?"
원문 | 
원문 | BIDDER
원문 | "Yeah! I guess I'll do it!"
원문 | KANA
원문 | "So, will anyone else
원문 | give up another card?
원문 | Anyone else at all?"
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'REMY' card, too?
원문 | "Is there anyone else
원문 | who will give up this card?
원문 | 
원문 | BIDDER
원문 | "Uh, I'll do it."
원문 | KANA
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'MORRIGAN' card, too?
원문 | "Is there anyone else
원문 | who will give up this card?
원문 | 
원문 | BIDDER
...
원문 | KANA
원문 | "So, will anyone else
원문 | give up a 'C.COMMAND' card, too?
원문 | Is there anyone else
원문 | who will give up both cards?"
원문 | 
원문 | BIDDER
...
원문 | the bid goes to this person!"
원문 | BIDDER
원문 | "Yes! I guess I'll do it!"
원문 | KANA
원문 | "Oh, we have a bidder!"
원문 | TAKA
원문 | "Then added to the other cards,
원문 | here's a 'LEON' card!
원문 | Anyone who'll give up
원문 | this one?
원문 | 
원문 | BIDDER
...
원문 | the bid goes to this person!"
원문 | BIDDER
원문 | "Hey! I raised my hand!"
원문 | KANA
원문 | "Oh, so you have!"
원문 | TAKA
원문 | "If that's the case, then
원문 | how about a 'MEGA MAN' card,
원문 | too?"
원문 | BIDDER
원문 | "......."
원문 | (LOOKS LIKE NO ONE WILL...) 
원문 | 
원문 | PULL "MEGA MAN" CARD?
원문 | {0D}
```
...
원문 | KEI
원문 | "Hey, {08}.
원문 | Got any extra coins?
원문 | 
원문 | What can I do to get
원문 | you to play me?"
원문 | PLAY AGAINST KEI?
원문 | {0D}
```
...
```
원문 | KEI
원문 | The Tokyo Championship's a
원문 | 3-win tourney.
원문 | I got to do my best, huh?
원문 | See you later!"
```
...
원문 | CAP
원문 | "Oh! {08}...
원문 | Apparently this year's Tokyo
원문 | Tourney's
원문 | an elimination tournament
원문 | against 3 players.
원문 | So, watch yourself, pal!
원문 | If you're game,
원문 | how 'bout a practice game?..."
원문 | 
원문 | PLAY AGAINST CAP?
원문 | {0D}
```
...
```
원문 | CAP
원문 | "To tell the truth,
원문 | I've got all the coins I need...
원문 | I'll be waiting at the tourney.
원문 | Good luck, {08}."
```
...
원문 | TAKA
원문 | "Whoo-hya!
원문 | The auction's begun
원문 | at NEOGEO World Tokyo!!"
원문 | KANA
원문 | "This time I'm gonna put
원문 | the 'NAKORURU' card
원문 | up for bidding!"
```
...
```
원문 | TAKA
원문 | "Along with a 'TERRY' card,
원문 | if you can give up this card too,
원문 | raise your hand!"
원문 | BIDDER
원문 | "I can!"
원문 | BIDDER
원문 | "I got a Terry card, too!
원문 | BIDDER
원문 | "Yeah! Me too!"
원문 | KANA
원문 | "Ooh! Popular from the start!
원문 | So, can anyone add another card,
원문 | with the 'TERRY' card?
원문 | PULL "TERRY" CARD?
원문 | {0D}
```
...
원문 | "Sorry to keep you waiting.
원문 | The Auction in
원문 | NEOGEO World has started!"
원문 | TAKA
원문 | "Whooo-hyah!
원문 | This card's the rarest of the rare!
원문 | It's a 'CHUN-LI (A)' card!"
```
...
원문 | "Yeah! Me too!"
원문 | BIDDER
원문 | "I got a CHUN-LI card, too!
원문 | KANA
원문 | "Ooh! Popular from the start!
원문 | So, can anyone add another card,
원문 | with the 'CHUN-LI' card?
원문 | PULL "CHUN-LI" CARD?
원문 | {0D}
```
...
```
원문 | CAP
원문 | "You're use of cards,
원문 | leaves something to be desired...
원문 | Memorize your cards' Abilities!"
```
...
원문 | SHIN
원문 | "Hey, {08}!
원문 | The Kid told me all about
원문 | Union Attacks!
원문 | I want to see what I learned.
원문 | How about a game?"
원문 | PLAY AGAINST SHIN?
원문 | {0D}
```
...
```
원문 | SHIN
원문 | "OK! I'll show you who's boss!"
```
...
원문 | SHIN
원문 | "Oooh whoooa!
원문 | I can't belieeeeeeeve it!
원문 | Shoot! ...Take these, jerk!"
```
...
```
원문 | SHIN
원문 | "Looks like the Tokyo Tourney's
원문 | a 3-game
원문 | elimination tourney.
원문 | I'll practice and enter.
원문 | Count on it! Later, dweeb!"
```
...
원문 | COMET
원문 | "Hey, big guy!
원문 | I heard this year's Tokyo
원문 | Tourney's 
원문 | a 3-game elimination tournament.
원문 | We gotta get serious!
원문 | If you're up for it,
원문 | 
원문 | how about a trial of fire with
원문 | me?"
원문 | PLAY AGAINST COMET?
원문 | {0D}
```
...
```
원문 | COMET
원문 | "Looks like you can't win, huh?
원문 | But cheer up! Here, take this!"
```
...
원문 | COMET
원문 | "Give me a break!
원문 | If you don't play harder,
원문 | this won't be much practice!"
```
...
```
원문 | COMET
원문 | "Hey, you're not the
원문 | kid I've heard about, are you?
원문 | You look like a mean card player!
원문 | How about it?
원문 | Want to play a game with me?"
원문 | PLAY AGAINST COMET?
원문 | {0D}
```
...
```
원문 | COMET
원문 | "Not in the mood, huh?...
원문 | Oh well, there's always next
원문 | time."
```
...
```
원문 | COMET
원문 | "Simply stunning play!
원문 | Try this out for size!"
```
...
```
원문 | COMET
원문 | "Let's get medieval for
원문 | the upcoming CARD CLASH tourney!
원문 | No prisoners! ...Later!"
```
...
```
원문 | KEI
원문 | "Whaddya lookin' for?
원문 | Lookin' for the manager?
원문 | Huh?! CARD CLASH?
원문 | If that's the case,
원문 | how 'bout facing off with me?"
원문 | PLAY AGAINST KEI?
원문 | {0D}
```
...
```
원문 | KEI
원문 | "Take me out to the CARD CLASH"
```
...
```
원문 | KEI
원문 | "Wow, you're boring.
원문 | I got no time for you!"
```
...
```
원문 | KEI
원문 | "I gotta get my act together!
원문 | See you later, card freak!"
```
...
```
원문 | NORI
원문 | "We meet again. If you play me,
원문 | I'll give you one of my treasured
원문 | Street Fighter series cards."
원문 | PLAY AGAINST NORI?
원문 | {0D}
```
...
```
원문 | HARUMI
원문 | "I'll win the next time!
원문 | If you defeat me,
원문 | I give you my SAMURAI CHA CARD
원문 | I guess it will never happen!"
원문 | 
원문 | PLAY AGAINST HARUMI?
원문 | {0D}
```
...
### `071E84`  79 → 81바이트  (빈 곳으로 옮겨 담음)

```
원문 | NONAKA
원문 | "Holy cardsharp! You're good.
원문 | Okay, from guy to guy,
원문 | here's a KOF card!"
```
...
원문 | I want a rematch!
원문 | If you win...,
원문 | I give you my best card,
원문 | SOUTH TOWN COLLECTION!"
원문 | PLAY AGAINST TAKE?
원문 | {0D}
```
...
```
원문 | MIKA
원문 | "Aw, melons! Lost again!
원문 | Me? I'm collecting these
원문 | CAPCOM arcade game characters...
원문 | Here, take this!"
원문 | Put it in your Deck if you want."
```
...
```
원문 | KANA
원문 | "Is that you, Champ?
원문 | Back again? Groovy!
원문 | You'll play me, won't you?"
원문 | PLAY AGAINST KANA?
원문 | {0D}
```
...
원문 | Here, take this.
원문 | 
원문 | It's a 'Dark Stalker' character
원문 | card!"
```
...
원문 | CAP
원문 | "Hmph...
원문 | So I guess you'll be joining
원문 | the CARD CLASH tourneys, too?...
원문 | Have you gotten any better?
원문 | How about it? One more game?"
원문 | PLAY AGAINST CAP?
원문 | {0D}
```
...
원문 | CAP
원문 | "Hmph...
원문 | Seems you've gotten better,
원문 | huh?...
원문 | Try this card on for size!"
```
...
```
원문 | CAP
원문 | "Go for it! I'm rooting for you!"
```
...
원문 | CAP
원문 | "Now THAT was fun!
원문 | I'm looking forward to
원문 | the next time we meet!"
```
...
원문 | SHIN
원문 | "Hey, {08}!
원문 | It was a hundred years ago!
원문 | This time, I play for keeps!
원문 | You can't refuse me!"
```
...
```
원문 | SHIN
원문 | "I'll win next time!
원문 | Don't go anywhere!"
```
...
원문 | I win, {08}
원문 | 
원문 | If you feel lucky,
원문 | how about going again?"
```
...
원문 | CAP
원문 | "Phew....
원문 | You probably know this but,
원문 | I can't be beat....
원문 | Hit me with your best shot!
원문 | Well, then, let's go!"
```
...
원문 | SHIN
원문 | "All right! At last!
원문 | This time, it's in the bag!
원문 | 
원문 | Sorry, {08}!
원문 | You don't got a chance!"
```
...
```
원문 | SHIN
원문 | "Excrement! You won, {08}!
원문 | No excuses!
원문 | 
원문 | Oh, take this little number!
원문 | It might be useful!"
```
...
원문 | COMET
원문 | "That's my boy!
원문 | Bet you're gunning for victory
원문 | again...
원문 | But I'll stop you in your tracks!
원문 | Don't hate me for this!
원문 | So, let's get this show on the
원문 | road!"
```
...
원문 | COMET
원문 | "I lost...
원문 | I guess you're just
원문 | way to good for me...
원문 | ...Here, take this card.
원문 | It may help you out."
```
...
원문 | COMET
원문 | "It's over, huh?
원문 | It fold so easy in future.
원문 | Next time, don't hold back!
```
...
```
원문 | COMET
원문 | "I'll be rooting for you!
원문 | Take care, card guy!"
```
...
```
원문 | COMET
원문 | "Hey there, card guy!
원문 | How about a game together?
원문 | I won't lose this time!"
원문 | PLAY AGAINST COMET?
원문 | {0D}
```
...
```
원문 | COMET
원문 | "'Lay up against a rainy day', eh?
원문 | Gotta get your deck ready for
원문 | battle!"
```

```
번역 | 코멧
번역 | "옛말에 "비 올 때를 대비하라"는
번역 | 말도 있잖아?
번역 | 덱을 잘 갖춰 두라고!"
```
...
원문 | {08}!!!
원문 | 
원문 | I didn't think you could do it.
원문 | But I'm no pushover!
원문 | Prepare yourself!
원문 | Let's get playing!"
```
...
원문 |   \ABILITY
원문 | 
원문 | The  "\ABILITY"  is  the
원문 | character's  special  ability.
원문 | The  "\ABILITY"  effect  is
원문 | activated  as  long  as  the
원문 | character with the ability is in
원문 | the Ring.
원문 | 
원문 | But the when character with an
원문 | "\ABILITY" is in a Unite Attack,
원문 | the "\ABILITY" is neutralized
원문 | for the rest of the turn.
```
...
```
원문 | FIRST, LET'S LEARN HOW
원문 | TO ARRANGE A DECK!
```
...
```
원문 | WHEN YOU GET 50 CARDS
원문 | YOU CAN ARRANGE DECKS.
```
...
### `0720F0`  36 → 39바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU CAN'T CHOOSE
원문 | 3 OF THE SAME CARD.
```
...
### `0720FC`  22 → 24바이트  (빈 곳으로 옮겨 담음)

```
원문 | CHOOSE WHO GOES FIRST.
```
...
### `072100`  41 → 44바이트  (빈 곳으로 옮겨 담음)

```
원문 | THE FIRST PLAYER CHOOSES
원문 | 1 CARD FROM PILE
```
...
```
원문 | DURING YOUR TURN, PICK
원문 | A CARD FROM YOUR HAND
```
...
### `07210C`  49 → 50바이트  (빈 곳으로 옮겨 담음)

```
원문 | DO THINGS IN ANY ORDER
원문 | UNTIL YOU SELECT "ATTACK."
```
...
### `072110`  32 → 45바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU CAN USE
원문 | 1 CHA CARD PER TURN.
```
...
### `072114`  23 → 27바이트  (빈 곳으로 옮겨 담음)

```
원문 | YOU CAN USE 3 CARDS MAX
```
...
```
원문 | WHEN A CHA CARD IS PUT IN THE
원문 | RING, "SP" RISES ACCORDINGLY.
```
...
```
원문 | THE "AC CARD" OFFERS HELP
원문 | TO GET THRU BATTLES.
```
...
```
원문 | WITH ENOUGH "SP", YOU CAN USE
원문 | NUMEROUS AC CARDS PER TURN.
```
...
```
원문 | WITH ONE IN YOUR HAND,
원문 | AND RAISE "BP" 300 PTS.
```
...
```
원문 | "BACK-UP" COMBINATIONS
원문 | VARY WITH EACH CHARACTER.
```
...
```
원문 | NEXT "ATTACK". USE IT AT THE
원문 | END OF YOUR TURN TO ATTACK.
```
...
```
원문 | CHARACTER JUST PUT IN RING
원문 | CAN'T ATTACK IN THAT TURN.
```
...
```
원문 | THOSE STILL IN RING LOSE
원문 | THE BP DIFFERENCE AS DAMAGE.
```
...
```
원문 | IF THERE'S NO "COUNTER",
원문 | ENEMIES ARE DAMAGED DIRECTLY.
```
...
### `072158`  40 → 42바이트  (빈 곳으로 옮겨 담음)

```
원문 | TO MAKE A "UNITE ATTACK",
원문 | YOU NEED "SP".
```
...
```
원문 | TO UNITE 2 CHARACTERS = 5 PTS.
원문 | TO UNITE 3 = 10 PTS.
```
...
```
원문 | IF YOU TAKE A "COUNTER" THEN,
원문 | IF YOU HAVE MORE "BP",
```
...
```
원문 | THE DIFFERENCE IS TAKEN DIRECTLY
원문 | FROM THE ENEMY AS DAMAGE.
```
...
```
원문 | TO REPEAT, IF HP OR CARDS
원문 | VALUES FALL TO "0", YOU LOSE.
```
...
### `072170`  20 → 21바이트  (빈 곳으로 옮겨 담음)

```
원문 | HERE ENDS RULE INFO.
```
...
```
원문 | AND THOSE WHOSE BP'S HIGHER
원문 | STAY IN RING.
```
...
검수맨 보고를 반영했습니다. 굵은 것이 「반드시」 항목입니다.

- **스트리트 파이터 3인 명칭 뒤바뀜** — 원문이 미국판 이름이라
  글자대로 옮기면 그림과 딴 사람이 붙었습니다.
  BALROG→바이슨 · VEGA→발로그 · M.BISON→베가
- **"S." 를 초(Super)로 일괄 오역** — 진공 파동권 ·
  스피닝 버드 킥 · 서머솔트 킥 · 슈퍼 헤드벗
- **사람 이름을 뜻으로 옮김** — 참철→잔테츠 · 비→레인
- **없는 카드 이름** — `070AE8` "기도"→"은총"
- **자리 표시 뒤 조사** — 이름이 자음으로 끝나면 "킹가"가
  되므로 조사 없는 꼴로 (`070348` `070368` `07036C`)
- 용어 통일 — 덱→더미 25건(대전 중 산패), 체력→HP/BP 19건
  (플레이어=HP · 캐릭터=BP), 주 단계 2건, 되받기 1건, 순서 2건
- 일본판 이름 원칙 적용 — 블루 마리 · 리무루루 · 콘루 ·
  아수라 · 페이롱 · 고우키 · 내쉬 · 레이레이 · 자벨 · 가론 ·
  포보스 · 불리타 · 타바사. **제작자 결정**으로 적용했습니다 —
  이미 록맨·블루스·바이오하자드로 일본판을 쓰고 있어
  일관성을 택했습니다.
- 경미 — 어순 1 · 무효로 한다 1 · SP 파트너 · 리셋 버튼 ·
  거절 2 · 플레이 시간 · 맞습니까 1 · 포가튼 말장난 1

※ 낱말을 바꾸면 **조사도 바뀝니다**. 덱(받침 O)→더미(받침 X)라
  「더미으로」가 나서 24곳을 따로 맞췄습니다.

## 알려진 제약

- **대소문자로 갈리던 카드 셋** — `kaede`/`KAEDE`,
  `guy`/`GUY`, `akira`/`AKIRA` 는 원문이 대소문자로만
  구분합니다. 한글에는 그 구분이 없어 이름이 같아집니다.
  다만 화면에 **카드 번호**(`No.C076` 꼴)가 같이 나오므로
  앨범에서 구분은 됩니다. 억지 붙임말을 넣지 않았습니다.
